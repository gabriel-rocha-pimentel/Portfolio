      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          <Link to="/" className="flex items-center space-x-2">
            ...
            >
              <img  alt="Tech&Connect Logo" className="h-10 w-auto rounded-sm" src="https://luhpdrcqztfexyorhrez.supabase.co/storage/v1/object/public/project-images/Profile/Logo.png" />
            </motion.div>
